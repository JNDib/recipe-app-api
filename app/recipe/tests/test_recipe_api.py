...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipe(self):
        """Test authenticated recipe retrieval."""
    ...
    # skipped video 87 here for adding more tests... come back to it
    ...
    def test_create_recipe_with_existing_tags(self):
        """test that creating a recipe with existing tags does not create duplicates"""
        tag_dessert = Tag.objects.create(user=self.user, name='Dessert')
        payload = {
            'title': 'Strawberry Shortcake',
            'time_minutes': 45,
            'price': Decimal('5.10'),
            'tags': [{'name': 'Dessert'}, {'name': 'Fruit'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient1 = Ingredient.objects.create(user=self.user, name='Pepperoni')
        recipe = create_recipe(user=self.user)
